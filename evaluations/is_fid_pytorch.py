...
if __name__ == '__main__':
    ...
    if not args.path:
        ...
        if args.save_stats_path:
            is_mean, is_std, _, mu, sigma = is_fid_model.get_score_dataset(IgnoreLabelDataset(cifar),
                                                                           ...
                                                                           n_split=split_num, return_stats=True)
            ...
            is_mean, is_std, _ = is_fid_model.get_score_dataset(IgnoreLabelDataset(cifar), n_split=split_num)
            print(is_mean, is_std)
    ...
    # if argv have foldername/, calc IS score of pictures in this folder
        ...
        if args.fid.endswith('.npz'):
            ...
            is_mean, is_std, fid = is_fid_model.get_score_image_tensor(img_list_tensor, n_split=split_num)
            print(is_mean, is_std)
            print('FID =', fid)
        ...
        # args.fid == a foldername/
            ...
            is_mean1, is_std1, _, mu1, sigma1 = \
                is_fid_model.get_score_image_tensor(img_list_tensor1, n_split=split_num, return_stats=True)
        ...
        # no args.fid
            ...
            if args.save_stats_path:
                ...
                is_mean, is_std, _ = is_fid_model.get_score_image_tensor(img_list_tensor, n_split=split_num)
                print(is_mean, is_std)
